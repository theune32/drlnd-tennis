...
class Agent:
    ...
    def __init__(self, state_size, action_size, random_seed, agent_count):
        ...
        self.critic_local = Critic(state_size, action_size, random_seed, agent_count).to(device)
        self.critic_target = Critic(state_size, action_size, random_seed, agent_count).to(device)
